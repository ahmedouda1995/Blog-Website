...
namespace WebApplication1
{
    ...
    public partial class topic_content1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int cid = int.Parse(Session["new cid"].ToString());
            ...
            while (rdr.Read())
            {
                ...
                commdate = rdr.GetDateTime(rdr.GetOrdinal("comment_date")) + "";
                ...
                tmp5.Text = ": was added on " + commdate + "<br /> <br />";
        ...
        protected void add_the_comm(object sender, EventArgs e)
        {
            ...
            Response.Redirect("add_comm1.aspx");
        }
