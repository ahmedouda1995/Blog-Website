...
{
    public partial class normaluserProfile : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("getinfoNormalUser", conn);
            ...
            if (!account.Equals(username))
            {
                ...
                form1.Controls.Remove(btn_friends);
                form1.Controls.Remove(btn_messages);
            }
            ...
            while (rdr.Read())
            {
                ...
                {
                    age = Convert.ToString(rdr.GetInt32(rdr.GetOrdinal("age")));
                }

                if (!rdr.IsDBNull(rdr.GetOrdinal("d_o_b")))
                {
                    date = Convert.ToString(rdr.GetDateTime(rdr.GetOrdinal("d_o_b")));
                }
