<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="delete_topic.aspx.cs" Inherits="WebApplication1.delete_topic" %>
...
<body style="background-color:bisque">
  ...
  <asp:ListItem Value="3">Conferences</asp:ListItem>
    ...
    <div>
     <asp:Label ID="label1" runat="server" Text="provide the below info to delete this topic."></asp:Label>
    <br />
        <br />
        <br />
        <asp:Label ID="label2" runat="server" Text="Member's email :  "></asp:Label>
        <asp:TextBox ID="textbox2" runat="server"></asp:TextBox>
            <br />
         <asp:Button ID="button1" runat="server" Text="delete" onclick="delete_topic_method" />
        <br />
    </div>
    </form>
</body>
