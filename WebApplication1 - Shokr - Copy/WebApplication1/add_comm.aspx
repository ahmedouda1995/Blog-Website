<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_comm.aspx.cs" Inherits="WebApplication1.add_comm" %>
...
<body style="background-color:bisque">
  ...
  <asp:ListItem Value="3">Conferences</asp:ListItem>
    ...
    <br />
        ...
        <asp:Button ID="button1" runat="server" Text="add" onclick="add_comm_method" />
