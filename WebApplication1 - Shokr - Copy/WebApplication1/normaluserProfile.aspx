<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="normaluserProfile.aspx.cs" Inherits="WebApplication1.normaluserProfile" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Normal Users Profile</title>
</head>
<body >
  ...
  <asp:ListItem Value="3">Conferences</asp:ListItem>
        ...
        <div >
            ...
            <br/>
            <asp:Label Text="First Name: " runat="server" style="margin-left:500px"> 
            </asp:Label>

            <asp:Label ID="lbl_fname" Text=" " runat="server"></asp:Label>
            <br/>
            <asp:Label Text="Last Name: " runat="server" style="margin-left:500px"> 
            </asp:Label>

            <asp:Label ID="lbl_lname" Text=" " runat="server"></asp:Label>
            <br/>
            <asp:Label Text="Date Of Birth: " runat="server" style="margin-left:500px"> 
            </asp:Label>

            <asp:Label ID="lbl_dob" Text=" " runat="server"></asp:Label>
            <br/>
            <asp:Label Text="Age: "  runat="server" style="margin-left:500px"> 
            </asp:Label>

            <asp:Label ID="lbl_age" Text=" " runat="server"></asp:Label>
            <br/>
        ...
        <div >
            ...
            <asp:Button ID="btn_messages" Text="View Messages" runat="server" OnClick="show_messages">  </asp:Button>
            <asp:Button ID="btn_friends" Text="Friends" runat="server" OnClick ="show_friends">  </asp:Button>
        </div>
    </form>
</body>
</html>
